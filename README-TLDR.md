...
2. **Wait**: The system will automatically install dependencies and start (if the terminal window disappears, just double-click the file again, and you should be up and running) - do not close the terminal, else LANStreamer Server session will end
